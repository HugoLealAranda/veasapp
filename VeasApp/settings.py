"""
Django settings for VeasApp project.
...
SECRET_KEY = 'django-insecure-num(b=f%@d23sasn$bwko&092b9wklv1u72n!ihe*+)e6^3ozt'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','veasapp-production.up.railway.app', 'veasapp.railway.internal','http://127.0.0.1:8000/']
